<?php
	$style_rep = $Level_rep . 'Styles/';
	$Accueil_rep = $Level_rep ;
	$image_rep = $Level_rep . 'Images/';
	$Albums_rep = $Level_rep . 'Albums/';
	$ZonePublic_rep =  $Level_rep . 'ZonePublic/';
	$Protect_rep = $Level_rep . 'ZoneProtegee/';
	$Include_rep = $Level_rep . 'Includes/';
	$Maintenance_rep = $Level_rep . 'ZoneProtegee/Maintenance/';
