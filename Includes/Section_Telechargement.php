	<section>
		<?php
			...
			echo '<h2> Telechargement album complet:   Année '. $YearDisplay . '   ' . $Album . '. </h2>';
			...
			echo '<a href="'. $display_Exit_Photo .'" id = "Bouton_Sortie" class="TelechargementBouton">  Retour affichage liste des albums </a>';
			echo '</div>';
